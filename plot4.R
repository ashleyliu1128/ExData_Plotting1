...
par(mfrow = c(2, 2))
with(subPowerCons, plot(DateTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))
with(subPowerCons, plot(DateTime, Voltage, type = "l", xlab = "datetime"))
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = 1, lwd = 1.5, bty = "n")
with(subPowerCons, plot(DateTime, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()